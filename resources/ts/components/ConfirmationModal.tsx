...
export const ConfirmationModal = ({ show, maxWidth = '2xl', closeable = true, close, footer, content, title }: ConfirmationModalProps) => {
  return (
    <Modal
      show={show}
      maxWidth={maxWidth}
      ...
      <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div className="sm:flex sm:items-start">
          ...
          <div className="mt-3 text-center sm:mt-0 sm:ms-4 sm:text-start">
            ...
            {content && <div className="mt-2 text-sm text-gray-600">
              {content}
            </div>}
          </div>
        </div>
